...
<div id="test_carousel_indicator_show_indicator" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item">
      <!-- START HALF -->
      <div class="container-fluid n_p">
        <div id="test_carousel_indicator_show_indicator_0" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <div class="row">
                <div class="col-xs-12">
        ...
        <div id="test_carousel_indicator_show_indicator_1" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <div class="row">
                <div class="col-xs-12">
    ...
    <div class="item">
      ...
      <div class="container-fluid n_p">
        ...
        <div id="test_carousel_indicator_show_indicator_2" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <div class="row">
                <div class="col-xs-12">
