  ...
  public function index()
  {
    if(isset($_POST['button']))
    {
      ...
      else
      {
        ...
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span> </button> Email dan Password yang dimasukkan salah. </div>');
